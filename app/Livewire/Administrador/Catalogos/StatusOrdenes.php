...
class StatusOrdenes extends Component
{
    ...
    public function new_form()
    {
        ...
        $this->validate([
            ...
            'newRegister.descripcion' => 'required|max:50',
        ], [
            ...
            'newRegister.descripcion.max' => __('La descripcion debe tener máximo 50 caracteres'),
    ...
    public function edit_form()
    {
        ...
        $this->validate([
            ...
            'editRegister.descripcion' => 'required|max:50',
        ], [
            ...
            'editRegister.descripcion.max' => __('La descripcion debe tener máximo 50 caracteres'),
        ]);
        //store
    ...
    public function estatus_register($id)
    {
        $this->estatus = true;
        $this->statusId = $id;
        $statusregister = estatus_orden_servicio::find($id);
        $this->viewstatus = $statusregister->estatus;
    }

    public function status_update()
    {
        $date = estatus_orden_servicio::find($this->statusId);
    ...
    public function render()
    {
        ...
        return view('livewire.administrador.catalogos.status-ordenes',compact('count','status'));
    }
}
