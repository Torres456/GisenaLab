...
class AnalisisEspecifico extends Component
{
    ...
    public function new_form()
    {
        ...
        catalogo_analisis_especifico::create([
            'nombre_comercial' => $this->newRegister['nombre'],
    ...
    public function edit_register($id)
    {
        ...
        $this->editRegister = [
            'nombre' => $register->nombre_comercial,
    ...
    public function edit_form()
    {
        ...
        $this->validate([
            ...
            'editRegister.tecnico' => ['required', 'max:250'],
            ...
            'editRegister.tecnico.max' => __('El nombre tecnico debe tener máximo 250 caracteres'),
        ...
        $categoria->update([
            'nombre_comercial' => $this->editRegister['nombre'],
    ...
    {
        $count= catalogo_analisis_especifico::where('nombre_comercial', 'LIKE', '%' . $this->search . '%')->count();
        $analisis_especificos = catalogo_analisis_especifico::where('nombre_comercial', 'LIKE', '%' . $this->search . '%')->paginate($this->view_dates);
        return view('livewire.administrador.catalogos.analisis-especifico',compact('count','analisis_especificos'));
    }
}
