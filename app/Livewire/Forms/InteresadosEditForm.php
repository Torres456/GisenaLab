...
class InteresadosEditForm extends Form
{
    ...
    public function update(){
        ...
        $this->validate([
            ...
            'nombre.new Les' => 'El nombre es muy largo',
            ...
            'telefono.max' => 'El teléfono debe ser numérico',
            'telefono_alter.required' => 'El teléfono alternativo es requerido',
            'correo.required' => 'El correo electrónico es requerido',
            'correo.email' => 'El correo electrónico no es válido',
            'correo.unique' => 'El correo electrónico ya está registrado',
            'correo_alter.required' => 'El correo alternativo es requerido',
            'correo_alter.email' => 'El correo electrónico no es válido',
            'gestor.required' => 'Seleccione un gestor',
            'calle.required' => 'La calle es requerida',
            'calle.max' => 'La calle es muy larga',
            ...
            'colonia.required' => 'Seleccione una colonia',
        ]);
