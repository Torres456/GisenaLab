<div>
    ...
    <div class="flex gap-3 items-center dark:text-white mb-5 max-md:flex-col">
        <div class="flex flex-row w-full gap-2">
            ...
            <div class="flex flex-col w-full">
                ...
                <x-input wire:model.live="search" placeholder="(Nombre recipiente)" class="w-full" />
            </div>
        </div>
                    ...
                    @foreach ($recipientes as $recipiente)
                        <tr
                            ...
                            <th scope="row"
                                ...
                                {{ $recipiente->id_recipiente }}
                            </th>
                            <td class="px-6 py-4 text-center">
                                {{ $recipiente->tipo_recipiente }}
                            </td>
                            <td class="px-6 py-4 text-center">
                                <x-button wire:click="edit_register({{ $recipiente->id_recipiente }})">
    ...
    <x-dialog-modal wire:model="new">
        <x-slot name='title'>
            <h2 class="text-center">Nuevo Recipiente</h2>
        </x-slot>
        <x-slot name='content'>
            <form wire:submit="new_form">
                <div>
                    <x-label>Nombre Recipiente:<span class="text-red-600">*</span></x-label>
    ...
    <x-dialog-modal wire:model="edit">
        <x-slot name='title'>
            <h2 class="text-center">Editar Recipiente</h2>
        </x-slot>
        <x-slot name='content'>
