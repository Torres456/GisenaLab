                ...
                <tbody>
                    @foreach ($categorias as $index => $categoria)
                        <tr
                            ...
                            <th scope="row"
                                class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white text-center" wire:key="cat-{{$categoria->id_categoria}}">
                                {{ $index }}
                            </th>
                            ...
                            <td class="px-6 py-4 text-center">
                                <x-button wire:click="edit_register({{ $categoria->id_categoria }})">
                            ...
                            <x-td>
                                @if ($categoria->estatus == 1)
                                    <x-button wire:click="estatus_register({{ $categoria->id_categoria }})">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                            stroke-linecap="round" stroke-linejoin="round"
                                ...
                                @else
                                    <x-danger-button wire:click="estatus_register({{ $categoria->id_categoria }})">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                            stroke-linecap="round" stroke-linejoin="round"
