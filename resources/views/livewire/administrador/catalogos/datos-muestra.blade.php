<div>
                    ...
                    @foreach ($datos_muestras as $datos_muestra)
                        <tr
                            ...
                            <th scope="row"
                                ...
                                {{ $datos_muestra->id_datos_muestra_especificos }}
                            </th>
                            <td class="px-6 py-4 text-center">
                                {{ $datos_muestra->descripcion_dato }}
                            </td>
                            <td class="px-6 py-4 text-center">
    ...
    <x-dialog-modal wire:model="new">
        <x-slot name='title'>
            <h2 class="text-center">Nuevo Datos Muestra</h2>
        </x-slot>
        <x-slot name='content'>
    ...
    <x-dialog-modal wire:model="edit">
        <x-slot name='title'>
            <h2 class="text-center">Editar Dato Muestra</h2>
        </x-slot>
        <x-slot name='content'>
