    ...
    <div class="flex gap-3 items-center dark:text-white mb-5 max-md:flex-col">
        <div class="flex flex-row w-full gap-2">
            ...
            <div class="flex flex-col w-full">
                ...
                <x-input wire:model.live="search" placeholder="(Nombre o clave del estado)" class="w-full" />
            </div>
        </div>
                ...
                <tbody>
                    @foreach ($estados as $estado)
                        <tr
                            ...
                            <td class="px-6 py-4 text-center">
                                <x-button wire:click="edit_register({{ $estado->id_estado }})">
    ...
    <x-dialog-modal wire:model="new">
        ...
        <x-slot name='content'>
            <form wire:submit="new_form">
                <div>
                    <x-label>Nombre estado:<span class="text-red-600">*</span></x-label>
                ...
                <div>
                    <x-label>Clave estado:<span class="text-red-600">*</span></x-label>
