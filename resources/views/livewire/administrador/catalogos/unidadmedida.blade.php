    ...
    <div class="flex gap-3 items-center dark:text-white mb-5 max-md:flex-col">
        <div class="flex flex-row w-full gap-2">
            ...
            <div class="flex flex-col w-full">
                ...
                <x-input wire:model.live="search" placeholder="(Nombre unidad de medida)" class="w-full" />
            </div>
        </div>
                ...
                <tbody>
                    @foreach ($datos as $dato)
                        <tr
                            ...
                            <x-td>
                                @if ($dato->estatus == 1)
                                    <x-button wire:click="estatus_register({{ $dato->id_unidad_medida }})">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                            stroke-linecap="round" stroke-linejoin="round"
                                ...
                                @else
                                    <x-danger-button wire:click="estatus_register({{ $dato->id_unidad_medida }})">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                            stroke-linecap="round" stroke-linejoin="round"
