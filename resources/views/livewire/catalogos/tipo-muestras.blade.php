                    ...
                    <div>
                        ...
                        <x-select wire:model="newRegister.unidad" type="text" class="block mt-1 w-full">\
                            ...
                            @foreach ($unidad_medidas as $unidad_medida)
                                <option value="{{ $unidad_medida->id_unidad_medida }}">{{  $unidad_medida->abreviatura . ' - ' . $unidad_medida->nombre_unidad}}
                                </option>
                            @endforeach
                        </x-select>
                ...
                <div>
                    ...
                    <x-select wire:model="newRegister.subcategoria" type="text" class="block mt-1 w-full">\
                        ...
                        @foreach ($subcategorias as $subcategoria)
                            <option value="{{ $subcategoria->id_subcategoria }}">{{ $subcategoria->nom_subcategoria }}
                            </option>
                        @endforeach
                    </x-select>
                ...
                <div class=" grid grid-cols-2 gap-5 max-md:grid-cols-1">
                    ...
                    <div>
                        ...
                        <x-select wire:model="editRegister.unidad" type="text" class="block mt-1 w-full">\
                            <option value="">Seleccione una opcion</option>
                            @foreach ($unidad_medidas as $unidad_medida)
                                <option value="{{ $unidad_medida->id_unidad_medida }}">{{ $unidad_medida->nombre_unidad }}
                                </option>
                            @endforeach
                        </x-select>
