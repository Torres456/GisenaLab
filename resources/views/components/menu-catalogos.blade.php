<div class="flex gap-4 justify-center items-center max-md:flex-row-reverse">
    <x-dropdown-catalogos>
        <x-slot name="trigger">
            <div class="flex dark:text-white justify-center items-center gap-2 cursor-pointer">
                <p>Catálogos</p> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
    ...
    <x-button-return href="{{ route('admin.catalogos.index') }}" wire:navigate.hover>Regresar</x-button-return>
</div>
